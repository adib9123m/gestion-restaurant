...
urlpatterns = [
    ...
    path('minuscart/', views.munis_cart),
    ...
    path('password-reset-comfirm/<uidb64>/<token>/',auth_view.PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html', form_class=MySetPasswordForm) ,name='password_reset_confirm'),
